...
namespace QuickApp
{
    ...
    /// </summary>
    public class CKcpCore<Segment> : IKcpSetting, IKcpUpdate, IDisposable
        where Segment : IKcpSegment
    {
        ...
        */
        ...
        public const int IKCP_WND_SND = 128;
        public const int IKCP_WND_RCV = 2048; // must >= max fragment size
        public const int IKCP_MTU_DEF = 1400;
        public const int IKCP_ACK_FAST = 3;
        public const int IKCP_INTERVAL = 1;
        ...
        protected void Flush()
        {
            ...
            unsafe
            {
                ...
                CKcpSegment seg = new CKcpSegment(ptr, 0);
