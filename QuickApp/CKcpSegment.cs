...
namespace QuickApp
{
    ...
    /// </summary>
    public struct CKcpSegment : IKcpSegment
    {
        internal readonly unsafe byte* ptr;
        internal unsafe CKcpSegment(byte* intPtr, uint appendDateSize)
        {
            this.ptr = intPtr;
            len = appendDateSize;
        }
        ...
        /// <returns></returns>
        public static CKcpSegment AllocHGlobal(int appendDateSize)
        {
            ...
            unsafe
            {
                ...
                return new CKcpSegment((byte*)intPtr.ToPointer(), (uint)appendDateSize);
            }
        }
        ...
        public static void FreeHGlobal(CKcpSegment seg)
        {
            unsafe
            {
